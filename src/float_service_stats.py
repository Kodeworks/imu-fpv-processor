...
class FloatServiceStats:
    ...
    def plot_vertical_position(float_service: FloatService):
        ...
        z_pos_dampened, = plt.plot(float_service.vertical_position, c='b', label='Dampened vert. pos')
    ...
    def plot_vertical_velocity(float_service: FloatService):
        ...
        z_vel_dampened, = plt.plot(float_service.vertical_velocity, c='b', label='Dampened vert. vel')
